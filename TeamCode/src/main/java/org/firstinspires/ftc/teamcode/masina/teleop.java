...
public class teleop extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()){
            ...
            if(gamepad1.left_stick_x>correctionThreshold) {
...
class Steering{
    ...
    public Steering(HardwareMap hm){
        ...
        MotorConfigurationType motorConfigurationType = steering.getMotorType().clone();
        motorConfigurationType.setAchieveableMaxRPMFraction(1.0);
        steering.setMotorType(motorConfigurationType);
    ...
    public void steer(double pos){
        ...
        telemetry.addData("currentSteering",steering.getCurrentPosition());
        telemetry.addData("targetSteering",target);
    }
